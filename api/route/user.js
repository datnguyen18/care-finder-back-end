...
router.patch('/:idUser', checkAuth, upload.fields([{ name: 'imageOfIdentificationFront' },{ name: 'imageOfIdentificationBack' }, { name: 'imageOfDiploma' }]), UserController.require_be_doctor);
